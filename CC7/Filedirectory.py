...
# # This code generates temporary folders for CC5 which was Fishnet code
...
input_directory = r"C:\Users\Wulan\Documents\Phd\Spring 2022\NRS528\coding-challenges\CC7"
...
for data in csvFiles:
    with open(str(data)) as speciesdata_csv:
