...
class HydrologyBundleToolbox(object):
    ...
    def execute(self, parameters, messages):
        ...
        if not os.path.exists(os.path.join(os.curdir, "temp_files")):
            os.mkdir(os.path.join(os.curdir, "temp_files"))
        ...
        output_fill = os.curdir + '/' + 'temp_files/fill'
        ...
        output_direction = os.curdir + '/' + 'temp_files/flow_dir'
        ...
        output_accumulation = os.curdir + '/' + 'temp_files/flow_acc'
        ...
        output_streamOrder = os.curdir + '/' + 'temp_files/stream_order'
        ...
        output_streamCondition = os.curdir + '/' + 'temp_files/stream_con'
        ...
        output_Flowlength = os.curdir + '/' + 'temp_files/_flow_len'
        ...
        output_watersheds = os.curdir + '/' + 'temp_files/watersheds'
        ...
        riverDistance = os.curdir + '/' + 'temp_files/RiverDistance'
        ...
        arcpy.Delete_management(os.path.join(os.curdir, "temp_files"))
        return
